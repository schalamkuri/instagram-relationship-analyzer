#!/usr/bin/env python3
"""
Script to extract all usernames from Instagram followers JSON file.
"""

import json
import os

def extract_usernames_from_followers(json_file_path):
    """
...
def main():
    # Path to your followers JSON file
    json_file_path = "followers_1.json"
    
    # Extract usernames
    print("Extracting usernames from followers file...")
    usernames = extract_usernames_from_followers(json_file_path)
